package com.encurtaurl.qrcode.ut;
...
/**
 * Testes unitários para a multiplicação de corpos de galois.
 *
 * @see <a href>https://codyplanteen.com/assets/rs/gf256_log_antilog.pdf</a>
 */
public class CorpoGaloisTest {

    private static final int[] LOOKUP_EXPOENTE = new int[] {
    ...
    private static final int[] LOOKUP_LOGARITMO = new int[] {
    ...
    @Test
    void garantirTabelaLookupExpoenteEstaPreenchidaCorretamente() {
        int possibilidadesLogaritmo = LOOKUP_LOGARITMO.length;
        for (int i = 1; i < possibilidadesLogaritmo; i++) {
            for (int j = 1; j < possibilidadesLogaritmo; j++) {
                int resultadoGalois = CorpoGalois.multiplicar(i, j);
                int resultadoTeste = LOOKUP_EXPOENTE[LOOKUP_LOGARITMO[i] + LOOKUP_LOGARITMO[j]];
                Assertions.assertEquals(resultadoTeste, resultadoGalois);
            }
        }
